            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" method="POST" action="{{ route('daoModule.update', $id) }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="_method" value="PUT">

                            @include('admin.daoModule._form')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="POST" action="{{ route('daoModule.destroy', $id) }}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
